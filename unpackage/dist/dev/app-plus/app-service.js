...
(function(vue, shared) {
  ...
  function _sfc_render(_ctx, _cache) {
    return vue.openBlock(), vue.createElementBlock("view", {
      id: "navBar",
      class: "position-fixed bottom-0 vw-100 bg-dark bg-opacity-10",
      ...
      vue.createElementVNode("view", { class: "position-absolute top-50 start-50 translate-middle" }, " 探索 "),
      vue.createElementVNode("view", {
        class: "position-absolute top-50 translate-middle",
        style: { "left": "75%" }
      }, " 我 ")
  ...
  const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render], ["__file", "C:/Study/WarmlyArticle/components/nav-bar/nav-bar.vue"]]);
  const _sfc_main$1 = {
    __name: "index",
    setup(__props) {
      let title = vue.ref("Hello2334");
      let changeTheme = () => {
        let root = document.getRootNode();
        formatAppLog("log", "at pages/index/index.vue:18", root);
        root.dataset.bsTheme = "dark";
      };
      return (_ctx, _cache) => {
        const _component_nav_bar = resolveEasycom(vue.resolveDynamicComponent("nav-bar"), __easycom_0);
        return vue.openBlock(), vue.createElementBlock("view", { class: "vw-100 vh-100 d-flex justify-content-center align-items-center bg-body-secondary" }, [
          vue.createElementVNode("view", { class: "" }, [
            ...
            vue.createElementVNode("button", {
              onClick: _cache[0] || (_cache[0] = (...args) => vue.unref(changeTheme) && vue.unref(changeTheme)(...args))
            }, "暗色")
          ]),
