  ...
  const _sfc_main$1 = {
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", {
          class: "vw-100 vh-100 d-flex justify-content-center align-items-center bg-body-secondary",
          "data-bs-theme": vue.unref(theme)
        }, [
          vue.createElementVNode("view", { class: "" }, [
            vue.createTextVNode(
              vue.toDisplayString(vue.unref(title)) + " " + vue.toDisplayString(vue.unref(theme)) + " ",
              1
              /* TEXT */
            ),
            vue.createElementVNode("button", {
              onClick: _cache[0] || (_cache[0] = (...args) => vue.unref(settingChangeTheme) && vue.unref(settingChangeTheme)(...args))
            }, "暗色")
          ]),
